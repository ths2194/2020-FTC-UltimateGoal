...
@TeleOp(name = "MrHaineDrive", group = "TeleOp")
@Disabled

public class MrHaineDrive extends MyOpMode {
    @Override
    public void runOpMode() {
        ...
        double targetShooterVelocity = 1525;
            ...
            while (opModeIsActive()) {
                ...
                if (!runningToPosition) {
                    if (controller1.rightBumper()) {
                        movement.setMotorPowers(FLPower,FRPower,BLPower,BRPower,.65);
                    } else if (controller1.leftBumper()) {
                        movement.setMotorPowers(FLPower,FRPower,BLPower,BRPower,0.25);
                    } else {
                        movement.setMotorPowers(FLPower,FRPower,BLPower,BRPower,0.45);
                    }
                } else {
